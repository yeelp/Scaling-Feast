...
public final class SFBuiltInModifiers {
	public static final class MaxHungerModifiers {
		...
		public static final BuiltInModifier XP = new BuiltInModifier(XPBonusType.getMaxHungerBonusUUID().toString(), "XP Bonus", Operation.ADD, Attribute.MAX_HUNGER);
	...
	public static final class FoodEfficiencyModifiers {
		public static final BuiltInModifier XP = new BuiltInModifier(XPBonusType.getFoodEfficiencyBonusUUID().toString(), "XP Bonus", Operation.PERCENT_MULTIPLY, Attribute.FOOD_EFFICIENCY);
