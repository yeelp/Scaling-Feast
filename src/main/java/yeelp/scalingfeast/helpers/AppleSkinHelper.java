...
public class AppleSkinHelper {
	 ...
	 * 
	 * @throws ClassNotFoundException if the classes used for reflection from
	 *                                AppleSkin can't be found.
	 */
	 ...
	 * 
	 * @return true if AppleSkinHelper.init() has returned successfully, i.e. the
	 *         class has loaded.
	 */
	 ...
	 * @return true if the operation was successful, false if not. If false, chances
	 *         are problems will persist, so it's best to not call this method after
	 *         it returns false as it will be a waste of processing.
	 */
