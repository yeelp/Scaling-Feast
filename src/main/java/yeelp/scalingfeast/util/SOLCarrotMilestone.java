...
public class SOLCarrotMilestone extends Milestone<Short> {
	 ...
	 * 
	 *                  <p>
	 *                  - m represents an integer satisfying 0 < m and denotes the
	 *                  amount of food eaten for this milestone
	 * 
	 *                  <p>
	 *                  - r represents an integer satisfying 0 < r < 32767 and
	 *                  denotes the amount of max hunger awarded at this milestone.
	 *                  In other words, r must be a valid positive short
	 *
	 * @throws IllegalArgumentException if milestone isn't a valid string that can
	 *                                  be parsed, or if either m or r are
	 *                                  non-positive
