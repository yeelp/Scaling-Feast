...
public class ModConfig 
{
	...
	public static ExtendedFoodStatsCategory extendedFoodStats = new ExtendedFoodStatsCategory();
	public static CompatCategory compat = new CompatCategory();
	public static ItemCategory items = new ItemCategory();
	public static HUDCategory hud = new HUDCategory();

	private static class ExtendedFoodStatsCategory
	{
		@Name("Global Cap")
	...
	private static class CompatCategory
	{
		public static AppleSkinCategory appleskin = new AppleSkinCategory();
		
		private static class AppleSkinCategory
		{
			...
			@Comment({"If true, Scaling Feast will make sure that AppleSkin's exhaustion underlay is drawn.",
				      "Set to false if AppleSkin is not installed, or AppleSkin isn't drawing the exhaustion underlay.",
				      "This only works if Display is set to OVERLAY"})
			public static boolean drawExhaustion = true;
			...
			@Comment({"If true, Scaling Feast won't draw coloured hunger shank outlines for vanilla saturation, only extended saturation.",
				      "Set this to true if AppleSkin is drawing the saturation overlay already.",
				      "If set to false, Scaling Feast will draw saturation outlines for all forms of saturation (vanilla and extended).",
				      "This only works if Display is set to OVERLAY"})
			public static boolean drawVanillaSatOverlay = false;
		}
	}
	private static class ItemCategory
	{
		...
		@RangeInt(min = 0)
		public static int heartyShankFoodLevel = 4;
		...
		@RangeDouble(min = 0)
		public static double heartyShankSatLevel = 0.8;
	}
	private static class HUDCategory
	{
		...
		@Comment({"The display style in the HUD.",
			      "if set to NUMERICAL, Scaling Feast will display a \'(x/X, Y)\' next to your hunger bar, where x is your current extended food level, X is your max food level, and Y is your saturation.",
			      "If set to OVERLAY, Scaling Feast will overlay coloured shanks over your hunger bar to display your extended food stats."})
		public static DisplayStyle style = DisplayStyle.OVERLAY;
		...
		@RequiresMcRestart
		public static String[] Hcolours = {"ff9d00", "ffee00", "00ff00", "0000ff", "00ffff", "e100ff", "ffffff"}; 
		...
		@Comment({"A List of hex colours for the coloured outline of the shanks for saturation. Each entry is of the form XXXXXX, where X is a hexadecimal digit",
				  ...
				  "If any invalid hex string is entered, it will be ignored."})
		@RequiresMcRestart
		public static String[] Scolours = {"d70000", "d700d7", "6400d7", "00d3d7", "64d700", "d7d700", "d7d7d7"}; 
	}
